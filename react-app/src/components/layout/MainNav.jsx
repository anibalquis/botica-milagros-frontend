...
export default function MainNav() {
  ...
  return (
    <nav
      className={`bg-white border-b border-gray-200 ${mobileMenuOpen ? "block" : "hidden lg:block"}`}
    >
          ...
          {navItems.map((item) => (
            <li key={item.path}>
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-2 px-4 py-3 lg:py-4 text-sm font-medium transition-colors border-b-2 ${
                    isActive
