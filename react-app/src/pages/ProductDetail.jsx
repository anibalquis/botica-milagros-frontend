    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-6">
            ...
            <nav className="text-sm text-gray-600 mb-6">
                ...
                <Link to="/productos" className="hover:text-green-600">Productos</Link>
                <span className="mx-2">&gt;</span>
                ...
                <div>
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        {product.originalPrice && (
                            <span className="text-xl text-gray-400 line-through">S/{product.originalPrice.toFixed(2)}</span>
                        )}
                        <span className="text-3xl font-bold text-green-600">S/{product.price.toFixed(2)}</span>
                    </div>
                    ...
                    <div className="flex gap-4 mb-6">
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span>Despacho: <span className="text-green-600 font-medium">Disponible</span></span>
                        </div>
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                            <i className="fas fa-store text-blue-500"></i>
                            <span>Retiro: <span className="text-blue-600 font-medium">Consultar</span></span>
                        </div>
                    </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
                <div className="bg-white rounded-xl shadow-md p-6">
                    ...
                    <ul className="text-sm text-gray-600 space-y-2">
                        ...
                        <li>• No usar si el sello está roto</li>
                    </ul>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                    ...
                    <ul className="text-sm text-gray-600 space-y-2">
                        <li>• Ingrediente activo principal</li>
                        <li>• Excipientes farmacéuticos</li>
                        <li>• Consultar empaque para detalles</li>
                    </ul>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                    ...
                    <ul className="text-sm text-gray-600 space-y-2">
                        <li>• Seguir indicaciones del médico</li>
                        <li>• No exceder dosis recomendada</li>
                        <li>• Consultar antes de combinar medicamentos</li>
                    </ul>
                </div>
            </div>
