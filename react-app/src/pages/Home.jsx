...
export default function Home() {
    ...
    const featuredProducts = products.filter(p => [49, 50, 51, 52, 53].includes(p.id));
    ...
    return (
        <div>
            ...
            <section className="max-w-7xl mx-auto px-4 py-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Link to="/productos" className="block">
                        <img src={adImg2} alt="Promoción" className="w-full rounded-xl hover:shadow-lg transition-shadow" />
                    </Link>
                    <Link to="/productos" className="block">
                        <img src={adImg2} alt="Promoción" className="w-full rounded-xl hover:shadow-lg transition-shadow" />
                    </Link>
            ...
            <section className="bg-gradient-to-r from-blue-50 to-pink-50 py-10 my-6">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            <h2 className="text-3xl font-bold text-gray-800 mb-4">
                                Los mejores productos para tu bebé<br />
                                <span className="text-green-600">con las marcas más confiables</span>
                            </h2>
                            <Link
                                to="/productos/bebes"
                            ...
                            <div className="flex gap-4 overflow-x-auto pb-4 slider-track">
                                {babyProducts.map((product) => (
                                    <Link
                                        ...
                                        className="flex-shrink-0 w-56 bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-all"
                                    >
                                        <img
                                            src={product.image}
                                            alt={product.name}
